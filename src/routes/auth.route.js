...
// // router.post('/registerVerification', validate(authValidation.registerVerification), authController.registerVerification);
// router.post('/login', validate(authValidation.login), authController.login);
// // router.post('/loginVerification', validate(authValidation.loginVerification), authController.loginVerification);
